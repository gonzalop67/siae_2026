...
class CreateAulasPeriodoTable extends Model
{
    ...
    public function up(): void
    {
        ...
        // 2. Estructura con la columna docente_id incluida
        $sql = "CREATE TABLE aulas_periodo (
            id INT(11) AUTO_INCREMENT PRIMARY KEY,
            periodo_lectivo_id INT(11) NOT NULL,
            curso_id INT(11) NOT NULL,
            paralelo_id INT(11) NOT NULL,
            docente_id INT(11) NULL DEFAULT NULL, -- 💡 COLUMNA FALTA: Guarda el ID del tutor
            ...
            CONSTRAINT fk_aulas_tutor FOREIGN KEY (docente_id) REFERENCES usuarios(id) ON DELETE SET NULL ON UPDATE CASCADE,
