...
class CalificacionesEstudiantesSeeder {
    ...
    public function run(mysqli $mysqli) {
        ...
        $queryInsert = "
            INSERT IGNORE INTO calificaciones_estudiantes 
            (insumo_evaluacion_id, alumno_id, nota, observacion) 
            VALUES (?, ?, ?, ?)
        ";
        ...
        $stmt->close();
        echo "Calificaciones inicializadas con éxito para todos los alumnos en cada insumo registrado.\n";
    }
}
